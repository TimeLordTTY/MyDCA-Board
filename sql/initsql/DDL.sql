...
CREATE TABLE `indicator_daily` (
  ...
  `boll_middle` DECIMAL(18, 6) NULL COMMENT 'BOLL中轨',
  `boll_upper` DECIMAL(18, 6) NULL COMMENT 'BOLL上轨',
  `boll_lower` DECIMAL(18, 6) NULL COMMENT 'BOLL下轨',
  `boll_std` DECIMAL(18, 6) NULL COMMENT 'BOLL标准差',
  `boll_window` INT NULL COMMENT 'BOLL窗口天数',
  `kdj_k` DECIMAL(18, 6) NULL COMMENT 'KDJ K值',
  `kdj_d` DECIMAL(18, 6) NULL COMMENT 'KDJ D值',
  `kdj_j` DECIMAL(18, 6) NULL COMMENT 'KDJ J值',
  `kdj_rsv` DECIMAL(18, 6) NULL COMMENT 'KDJ RSV值',
  `kdj_window` INT NULL COMMENT 'KDJ窗口天数',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
