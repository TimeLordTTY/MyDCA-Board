    ...
    },
    {
      ...
      children: [
        ...
        // 设置页面内的子功能页面
        {
          path: 'accounts',
          name: 'Accounts',
          component: () => import('../views/AccountsMobile.vue'),
          meta: { title: '账户管理' },
        },
        {
          path: 'products',
          name: 'Products',
          component: () => import('../views/ProductsMobile.vue'),
          meta: { title: '产品管理' },
        },
        {
          path: 'ledger',
          name: 'Ledger',
          component: () => import('../views/LedgerMobile.vue'),
          meta: { title: '流水查询' },
        },
        {
          path: 'orders',
          name: 'Orders',
          component: () => import('../views/OrdersMobile.vue'),
          meta: { title: '订单管理' },
        },
      ],
    },
